...
Ouvrez ensuite VisualStudioCode, ou votre IDE habituel, puis utilisez la commande ``git clone [github.com/HenanAeroo/Projet_Infrastrucut](https://github.com/HenanAeroo/Projet_Infrastructure_Henan_NOEL)``.
